...
import img from "./../assets/hangman2.png";
import img2 from "./../assets/mann.gif";
...
const Home = () => {
  return (
    <>
      <Container
        fluid
        className="vh-100 landing-container d-flex align-items-center justify-content-center"
      >
        <Row className="full-row">
          ...
          >
            {" "}
            <div className="text-center slogan-row">
